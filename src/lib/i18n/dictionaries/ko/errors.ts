export const errors = {
  ...
  memberRoleUnchanged: '이미 그 권한 상태입니다',
  setAdminFailed: '권한 변경에 실패했습니다',
  memberDetailLoadFailed: '회원 상세 정보를 불러오지 못했습니다',
  memberDeletedImmutable: '삭제된 계정은 수정할 수 없습니다',
  guestProfileImmutable: '게스트 계정은 이름·전화번호를 바꿀 수 없습니다',
  memberPhoneTaken: '이미 다른 회원이 쓰는 전화번호입니다',
  memberProfileUpdateFailed: '회원 정보를 저장하지 못했습니다',
  memberHasNoPasswordLogin: '아이디·비밀번호 로그인을 쓰지 않는 계정입니다',
  memberPasswordResetFailed: '비밀번호를 초기화하지 못했습니다',
  memberStatusReasonRequired: '정지·삭제에는 사유가 필요합니다',
  cannotChangeOwnStatus: '자기 계정의 상태는 바꿀 수 없습니다',
  memberStatusUnchanged: '이미 그 상태입니다',
  memberStatusChangeFailed: '계정 상태를 바꾸지 못했습니다',
