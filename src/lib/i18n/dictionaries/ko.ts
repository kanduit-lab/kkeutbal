export const ko = {
  ...
  adminConsole: {
    ...
    vision: {
      title: '사진 인식 설정',
      description: 'Anthropic 또는 Gemini로 화투 사진의 패를 보조 인식합니다',
      enable: '사진 인식 사용',
    ...
    members: {
      ...
      empty: '일치하는 회원이 없습니다',
      emptyHint: '검색어 {query} 와 맞는 회원이 없어요. 검색어를 지우면 전체가 보입니다',
      noUsername: '아이디 없음',
      joinedAt: '{date} 가입',
      adminBadge: '관리자',
      guestBadge: '게스트',
    ...
    rooms: {
      title: '진행 중인 방',
      empty: '진행 중인 방이 없습니다',
      emptyHint: '누군가 방을 만들면 여기에서 강제 정산할 수 있어요',
  ...
  wallet: {
    ...
    total: '총 가상 크레딧',
    totalHint: '현금 가치·환전·출금이 없는 게임 전용 수치입니다',
    historyTitle: '거래 기록',
    historyHint: '최근 50건 · 수정 대신 반대 거래로 정정됩니다',
    ...
    admin: {
      title: '가상 크레딧 관리',
      description:
        '현금 가치·환전·출금이 없는 게임 전용 크레딧입니다. 모든 지급·회수는 사유와 함께 변경 불가 원장에 남습니다.',
      noUsers: '조정할 사용자가 없습니다',
      noUsersHint: '회원이 가입하면 여기에서 크레딧을 지급할 수 있어요',
      targetLabel: '대상 사용자',
      amountLabel: '조정 크레딧',
  ...
  lobby: {
    ...
    inviteGuest: '게스트',
    guestJoinHint: '계정이 없는 사람용이에요. 관리자에게 받은 게스트 토큰과 이름을 넣으면 들어와요',
    copyCode: '코드 복사',
    copyLink: '링크 복사',
  ...
  advisor: {
    ...
    vision: {
      ...
      tooLarge: '사진이 너무 큽니다. 15MB 이하로 촬영하세요',
      preview: '보낸 사진',
      retake: '다시 촬영',
    },
  },
  ...
  fairness: {
    ...
    commitmentCopied: 'commitment 를 복사했어요',
    copyFailed: '복사가 안 돼요',
