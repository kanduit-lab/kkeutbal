...
export const en: Dictionary = {
  ...
  adminConsole: {
    ...
    vision: {
      ...
      description: 'Uses Anthropic or Gemini to assist reading 화투 cards from a photo',
    ...
    rooms: {
      ...
      playingSuffix: ' · 판 in progress',
      close: 'Force settle',
      closeTitle: 'Force-settle room {code} · {name}?',
      closeBody:
        '{members} people are in this room. Any 판 in progress is voided and the room settles immediately.',
      closedToast: 'Room force-settled',
    },
  },
  wallet: {
    title: 'My virtual credits',
    subtitle: 'Account-bound · no cash value · every change is kept',
    ...
    totalHint: 'A game-only number with no cash value, exchange, or withdrawal',
    historyTitle: 'Transaction history',
    historyHint: 'Last 50 entries · corrected by reversal, never edited',
    ...
    admin: {
      ...
      description:
        'Game-only credits with no cash value, exchange, or withdrawal. Every grant and revoke is written to an immutable ledger with its reason.',
  ...
  room: {
    ...
    snapshotFailedHint: 'Please try again in a moment.',
    potAnnounce: 'Pot {n}',
  },
  table: {
  ...
  lobby: {
    ...
    inviteGuest: 'Guest',
    guestJoinHint:
      'For people without an account. They enter the guest token from an admin plus a display name',
    copyCode: 'Copy code',
    copyLink: 'Copy link',
    ...
    addLocalMemberHint:
      'For people you record on this device instead of having them sign in. The dealer places their bets, and they count normally in the standings and settlement',
  ...
  advisor: {
    ...
    vision: {
      ...
      sourceBadge: 'Photo recognition · confidence {confidence}% · please verify',
      undo: 'Undo',
  ...
  errors: {
    ...
    registrationCodeGenerationFailed: 'Failed to generate a registration code. Please try again',
    createGuestTokenFailed: 'Failed to issue the guest token',
    guestTokenGenerationFailed: 'Failed to generate a guest token. Please try again',
